...
// // console.log("I can type anything here!"); //included a string in quotation marks
//
...
// console.log("My new Soundcloud persona is: " + firstArray[2] + " " + secondArray[5]);
//
//
// // //DJ
// // //Dr. Distancing
...
console.log(addNumberAndReturn(400,200) + " " + addNumberAndReturn(100, 200));
